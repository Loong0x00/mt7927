...
| **MLO 双链路 (5GHz+2.4GHz)** | **✅ Link1+Link2, ping 10/10** |
| **MLO 双链路 (6GHz+2.4GHz)** | **✅ Link0+Link2, ping 10/10** |
| **MLO 三链路发现** | **✅ 6G+5G+2.4G 全部通过 Multi-Link element 发现** |

### MLO 补丁与上游提交

**补丁**: `patches/mt6639-wifi-mlo.patch` (6 文件, ~340 行)
...
**6GHz 发现方式**: 无需清除 NO_IR，AP (ASUS RT-BE92U) 在 2.4/5GHz beacon 中包含
Multi-Link element，mac80211 通过该 element 自动发现 6GHz 链路 (ch133 = 6615 MHz)。
