...
- wpa_supplicant MLD 发现: valid_links=0007 (link0=6G, link1=5G, link2=2.4G)
- 连接状态: COMPLETED, ap_mld_addr=60:cf:84:fd:2d:aa, wifi_generation=7
- valid_links=0x4 (link_id=2, 2.4GHz), SAE+PMF+CCMP
- **Ping 192.168.52.1: 3/3 成功, 15-49ms**
- 详见: `docs/debug/mlo_single_link_dataplane_fix.md`
...
**未解决 — 双链路 MLO**:
- `mac_set_links()` 中的 `set_mlo_roc` + `ieee80211_set_active_links_async` 流程需调查
- marcin-fm 的 band_idx/ROC 补丁可能是关键 (尚未发布)
